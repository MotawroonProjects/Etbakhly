...
import com.etbakhly.databinding.FragmnetServicesFoodTruckBinding;
...
public class FragmentServices extends Fragment {
    ...
    private FragmnetServicesFoodTruckBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragmnet_services_food_truck, container, false);
        initView();
